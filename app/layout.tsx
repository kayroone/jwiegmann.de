...
export const metadata: Metadata = {
  ...
  description:
    "Jan Wiegmann - Software Architect at adesso SE. Specializing in innovative and sustainable solutions in the public sector, insurance, and government modernization.",
  keywords: [
    "Jan Wiegmann",
    "Software Architect",
    "adesso",
  ...
  openGraph: {
    ...
    title: "Jan Wiegmann | Software Architect",
    description:
      "Software Architect at adesso SE specializing in innovative and sustainable solutions",
